...
@section('estilos')
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
		...
		<!--[if lte IE 9]>
			{!!Html::style('/plantilla/css/ace-part2.min.css')!!}
		<![endif]-->
	...
	<div class="page-content">
		...
		<div class="col-xs-12">	
			...
			<div class="form-group no-margin-bottom">
				<label class="col-sm-3 control-label no-padding-right">Adjuntar documento:</label>
				<div class="col-sm-9">
...
@section('script')
		...
		{!!Html::script('/plantilla/js/bootstrap-tag.min.js')!!}
		{!!Html::script('/plantilla/js/jquery.hotkeys.index.min.js')!!}
