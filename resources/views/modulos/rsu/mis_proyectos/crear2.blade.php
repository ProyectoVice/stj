...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="/plantilla/font-awesome/4.5.0/css/font-awesome.min.css" />

		<!-- page specific plugin styles -->

		<!-- text fonts -->
		<link rel="stylesheet" href="/plantilla/css/fonts.googleapis.com.css" />

		<!-- ace styles -->
		<link rel="stylesheet" href="/plantilla/css/ace.min.css" class="ace-main-stylesheet" id="main-ace-style" />

		<!--[if lte IE 9]>
			<link rel="stylesheet" href="/plantilla/css/ace-part2.min.css" class="ace-main-stylesheet" />
		<![endif]-->
		<link rel="stylesheet" href="/plantilla/css/ace-skins.min.css" />
		<link rel="stylesheet" href="/plantilla/css/ace-rtl.min.css" />
		...
		<script src="/plantilla/js/ace-extra.min.js"></script>
					...
					<ul class="nav ace-nav">
									...
									<ul class="dropdown-menu dropdown-navbar">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="/plantilla/images/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
												<span class="msg-body">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="/plantilla/images/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="/plantilla/images/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="/plantilla/images/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="/plantilla/images/avatars/user.jpg" alt="Jason's Photo" />
...
<![endif]-->
		...
		<!-- ace scripts -->
		<script src="/plantilla/js/ace-elements.min.js"></script>
		<script src="/plantilla/js/ace.min.js"></script>
