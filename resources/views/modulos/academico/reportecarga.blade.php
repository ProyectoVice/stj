...
@section('titulo','Reporte - Carga Lectiva')
@section('activacion')
@endsection
@section('estilos')  
@endsection
...
<ul class="breadcrumb">
  ...
  <li class="active">Carga por docente</li>
  <li class="">Usuario</li>
</ul>
@endsection
@section('contenido')
