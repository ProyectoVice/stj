<div>
    <fieldset>
<!-- Form Name -->
		<legend>Inscripcion Posgrado Maestria</legend>

<!-- Text input-->

    <div class="form-group">
        <label class="col-md-4 control-label">Maestria-Area</label>  
        <div class="col-md-4 inputGroupContainer">
          <div class="input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
            {!!Form::select('maestriasarea',$maestriaareas,null,['required','id'=>'maestria_area', 'class'=>'form-control selectpicker','placeholder' => 'Maestria-Area'])!!}
          </div>
        </div>
    </div>    
...
<!-- Text input-->
    ...
    <div class="form-group">
        <label class="col-md-4 control-label">Maestria</label>  
        <div class="col-md-4 inputGroupContainer">
          <div class="input-group">
            <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
            {!!Form::select('maestria',$maestrias,null,['required','id'=>'maestria_u', 'class'=>'form-control selectpicker','placeholder' => 'Maestria'])!!}
          </div>
        </div>
    </div>
