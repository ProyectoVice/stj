...
class DatosInscripcionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('pagos')->insert([
            ['num_comprobante' => '1234567', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Juan', 'dni_cliente'=> '12345678',
            'detalle'=> 'Seleccion General Medicina Humana-Nacional', 'importe'=> '350', 'estado_recibo'=> '0',],
            ['num_comprobante' => '1234566', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Maria', 'dni_cliente'=> '12345666',
            'detalle'=> 'CEPREVAL Medicina Humana-Nacional', 'importe'=> '600', 'estado_recibo'=> '0',],
            ['num_comprobante' => '1111111', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'pedro', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-matricula', 'importe'=> '150', 'estado_recibo'=> '1',],
            ['num_comprobante' => '2222222', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'pedro', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-modulo', 'importe'=> '250', 'estado_recibo'=> '1',],
            ['num_comprobante' => '3333333', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'pedro', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-diploma', 'importe'=> '20', 'estado_recibo'=> '1',],
            ['num_comprobante' => '4444444', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'marta', 'dni_cliente'=> '12345678',
            'detalle'=> 'PROCAPT-matricula', 'importe'=> '500', 'estado_recibo'=> '1',],
            ['num_comprobante' => '5555555', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'marta', 'dni_cliente'=> '12345678',
            'detalle'=> 'PROCAPT-modulo', 'importe'=> '700', 'estado_recibo'=> '0',],
            ['num_comprobante' => '1111222', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Juanito', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-matricula', 'importe'=> '150', 'estado_recibo'=> '0',],
            ['num_comprobante' => '1111333', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Pedro', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-matricula', 'importe'=> '150', 'estado_recibo'=> '0',],
            ['num_comprobante' => '1111444', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Karol', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Tics-matricula', 'importe'=> '100', 'estado_recibo'=> '1',],
            ['num_comprobante' => '1111555', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Jesus', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-modulo', 'importe'=> '200', 'estado_recibo'=> '0',],
            ['num_comprobante' => '1111666', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Luis', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Tics-modulo', 'importe'=> '250', 'estado_recibo'=> '0',],
            ['num_comprobante' => '1111777', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Luis', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Tics-modulo', 'importe'=> '300', 'estado_recibo'=> '0',],
            ['num_comprobante' => '1111888', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Rafael', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-todos los modulo', 'importe'=> '650', 'estado_recibo'=> '0',],
            ['num_comprobante' => '2222333', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Juanito', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-matricula', 'importe'=> '150', 'estado_recibo'=> '0',],
            ['num_comprobante' => '2222444', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Pedro', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-matricula', 'importe'=> '150', 'estado_recibo'=> '0',],
            ['num_comprobante' => '2222555', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Karol', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Tics-matricula', 'importe'=> '100', 'estado_recibo'=> '0',],
            ['num_comprobante' => '2222666', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Jesus', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-modulo', 'importe'=> '200', 'estado_recibo'=> '0',],
            ['num_comprobante' => '2222777', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Luis', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-modulo', 'importe'=> '250', 'estado_recibo'=> '0',],
            ['num_comprobante' => '2222888', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Luis', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-modulo', 'importe'=> '200', 'estado_recibo'=> '0',],
            ['num_comprobante' => '2222999', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Rafael', 'dni_cliente'=> '12345678',
            'detalle'=> 'Diplomado en Gestion por Procesos-todos los modulo', 'importe'=> '650', 'estado_recibo'=> '0',],
            ['num_comprobante' => '3333111', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Pedro', 'dni_cliente'=> '12345678',
            'detalle'=> 'Seleccion General Otras Carreras Profesionales - Nacional', 'importe'=> '280', 'estado_recibo'=> '1',],
            ['num_comprobante' => '3333222', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Luciana', 'dni_cliente'=> '12345678',
            'detalle'=> 'CEPREVAL Otras Carrera Profesional -Nacional', 'importe'=> '500', 'estado_recibo'=> '1',],
            ['num_comprobante' => '3333444', 'fecha_comprobante' => '2018-05-21', 'nombre_cliente'=> 'Luciana', 'dni_cliente'=> '12345678',
