 ...
 * Generated for Laravel 5.5.40 on 2018-06-06 21:44:28.
 *
...
namespace Softon\SweetAlert\Facades { 
    ...
    class SWAL {
         ...
         *
         * @param \Softon\SweetAlert\title  string
         * @param \Softon\SweetAlert\text  string
         * @param \Softon\SweetAlert\type  string
         * @param \Softon\SweetAlert\options  array
         * @return object 
         * @static 
         */ 
        public static function message($title = '', $text = '', $type = '', $options = array())
        {
            return \Softon\SweetAlert\SweetAlert::message($title, $text, $type, $options);
        }
         ...
         * @param string
         * @param array
         * @return \Softon\SweetAlert\[type] 
         * @static 
         */ 
        public static function warning($title = '', $text = '', $options = array())
        {
            return \Softon\SweetAlert\SweetAlert::warning($title, $text, $options);
        }
         ...
         * @static 
         */ 
        public static function error($title = '', $text = '', $options = array())
        {
            return \Softon\SweetAlert\SweetAlert::error($title, $text, $options);
        }
         ...
         * @static 
         */ 
        public static function success($title = '', $text = '', $options = array())
        {
            return \Softon\SweetAlert\SweetAlert::success($title, $text, $options);
        }
         ...
         * @static 
         */ 
        public static function info($title = '', $text = '', $options = array())
        {
            return \Softon\SweetAlert\SweetAlert::info($title, $text, $options);
        }
         ...
         * @static 
         */ 
        public static function question($title = '', $text = '', $options = array())
        {
            return \Softon\SweetAlert\SweetAlert::question($title, $text, $options);
        }
        ...
        {
            return \Softon\SweetAlert\SweetAlert::loadConfig($config);
        }
         ...
         * @static 
         */ 
        public static function autoclose($time = 2000)
        {
            return \Softon\SweetAlert\SweetAlert::autoclose($time);
        }
        ...
        {
            return \Softon\SweetAlert\SweetAlert::toast();
        }
         ...
         * @param string
         * @param boolean
         * @param \Softon\SweetAlert\[type]
         * @return \Softon\SweetAlert\[type] 
         * @static 
         */ 
        public static function button($text = 'OK', $color = '#3085d6', $style = true, $class = null)
        {
            return \Softon\SweetAlert\SweetAlert::button($text, $color, $style, $class);
        }
         ...
         * @static 
         */ 
        public static function position($value = 'center')
        {
            return \Softon\SweetAlert\SweetAlert::position($value);
        }
...
namespace  { 
    ...
    class SWAL extends \Softon\SweetAlert\Facades\SWAL {}
